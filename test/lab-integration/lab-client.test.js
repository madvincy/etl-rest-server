...
describe.only('Lab Client Test Suite:', function () {
    ...
    it('Should Fetch Viral Load results given server config',
        function (done) {
            ...
            client.fetchViralLoad({ start_date: '', end_date: '', patient_id: '' }).then((results) => {
    ...
    it('Should Fetch CD4 results given server config',
        function (done) {
            (typeof (client.fetchViralLoad)).should.equals('function');
            ...
            client.fetchDNAPCR({ start_date: '', end_date: '', patient_id: '' }).then((results) => {
                expect(results).to.eql({
                    "current_page": 1,
                    "data": [
                        {
    ...
    it('Should Fetch DNA PCR results given server config',
        function (done) {
            (typeof (client.fetchViralLoad)).should.equals('function');
            ...
            client.fetchCD4({ start_date: '', end_date: '', patient_id: '' }).then((results) => {
                expect(results).to.eql({
                    "current_page": 1,
                    "data": [
                        {
