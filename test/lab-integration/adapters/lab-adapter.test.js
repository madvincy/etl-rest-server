...
describe('Lab Adapters Unit Tests', function () {
  ...
  it('should throw LabAdapterError if result is not array',
    function (done) {
      (function () {
  ...
  it('should ensure that convertDNAPCRPayloadTORestConsumableObs receives  the right input and generates the correct payload: negative',
    function (done) {
      const patientUuId = "c6e4e026-3b49-4b64-81de-05cf8bd18594";
      const expectedInput = [
        {
  ...
  it('should ensure that convertDNAPCRPayloadTORestConsumableObs receives  the right input and generates the correct payload: positive',
    function (done) {
      const patientUuId = "c6e4e026-3b49-4b64-81de-05cf8bd18594";
      const expectedInput = [
        {
